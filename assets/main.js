(() => {
  ...
  const translations = {
    pt: {
      ...
      voip_v_protocols: 'SIP/RTP e fluxo de chamadas',
      voip_k_debug: 'Diagnóstico',
      voip_v_debug: 'Análise de logs e PCAP',
      voip_k_sbc: 'Infra',
      ...
      voip_k_webrtc: 'WebRTC',
      voip_v_webrtc: 'Integração de WebRTC para VoIP em sistema de frota',
      voip_k_gps: 'GPS',
      voip_v_gps: 'Rastreamento em tempo real e histórico de rotas',
      voip_k_troubleshoot: 'Troubleshooting',
      voip_v_troubleshoot: 'Resolução de one-way audio, latência e quedas',
      voip_k_apis: 'APIs',
      voip_v_apis: 'RESTful APIs + WebSockets para comunicação em tempo real',
      voip_k_devops: 'DevOps',
      voip_v_devops: 'CI/CD, Docker e deploy em nuvem',
      voip_k_dashboards: 'Dashboards',
      voip_v_dashboards: 'Análise em tempo real, geofencing e otimização de rotas',
      voip_k_security: 'Segurança',
      voip_v_security: 'Passport.js + RBAC e agendamento de manutenção',
      voip_k_pwa: 'PWA',
      voip_v_pwa: 'Aplicativo mobile responsivo (Progressive Web App)',
    ...
    en: {
      ...
      voip_v_protocols: 'SIP/RTP and call flow',
      voip_k_debug: 'Debugging',
      voip_v_debug: 'Log analysis and PCAP',
      voip_k_sbc: 'Infra',
      ...
      voip_k_webrtc: 'WebRTC',
      voip_v_webrtc: 'WebRTC integration for VoIP in fleet system',
      voip_k_gps: 'GPS',
      voip_v_gps: 'Real-time tracking and route history',
      voip_k_troubleshoot: 'Troubleshooting',
      voip_v_troubleshoot: 'Resolving one-way audio, latency and drops',
      voip_k_apis: 'APIs',
      voip_v_apis: 'RESTful APIs + WebSockets for real-time communication',
      voip_k_devops: 'DevOps',
      voip_v_devops: 'CI/CD, Docker and cloud deployment',
      voip_k_dashboards: 'Dashboards',
      voip_v_dashboards: 'Real-time analytics, geofencing and route optimization',
      voip_k_security: 'Security',
      voip_v_security: 'Passport.js + RBAC and maintenance scheduling',
      voip_k_pwa: 'PWA',
      voip_v_pwa: 'Mobile-responsive Progressive Web App',
